...
We welcome and appreciate all contributions from the community. By contributing to `chroma-print`, you agree to abide by the [code of conduct](/CODE_OF_CONDUCT.md).
...
Unsure of where to begin contributing to `chroma-print`? You can start by looking through the issues labeled _good-first-issue_ and _help-wanted_. You can also start by contributing to the project documentation (e.g files with extension `.md`).
...
1. [Fork](https://docs.github.com/en/github/getting-started-with-github/fork-a-repo) the `chroma-print` repository.
...
Once you have cloned `chroma-print` and completed [Setup](#setup), you can lint, format, build, and test the code from your terminal.
...
To compile the `chroma-print` source, run:
...
Once you have finished working on an issue or feature, you can submit a pull request to have your changes merged into the `chroma-print` repository and included in the next release.
